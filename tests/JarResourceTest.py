...
class Test(unittest.TestCase):
    ...
    def testA_InstallSingleArchiveResource(self):
        ...
        self.setManifest("manifests/jar_manifest.json")
    ...
    def testB_UninstallSingleArchiveResource(self):
        ...
        self.setManifest("manifests/updates/jar/add/1.json")
    ...
    def checkExistsLinux64(self):
        self.assertTrue(self.fsHelp.exists("../jre/bin"))
        pass
    ...
    def checkDeletedLinux64(self):
        self.assertFalse(self.fsHelp.exists("../jre/bin"))
        self.assertFalse(self.fsHelp.exists("../jre"))
