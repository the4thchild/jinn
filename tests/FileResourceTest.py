...
#the names of these tests are to keep the order consistent
    # test to install a file resource
    def testA_InstallSingleFileResource(self):
        

        self.setManifest("manifests/file_manifest.json")
    ...
    # test to uninstall a file resource
    def testB_UninstallSingleFileResource(self):
    ...
    def checkExistsLinux64(self):
        self.assertTrue(self.fsHelp.exists("../TestData/humans.txt"))
        pass
    ...
    def checkDeletedLinux64(self):
        self.assertFalse(self.fsHelp.exists("../TestData/humans.txt"))
